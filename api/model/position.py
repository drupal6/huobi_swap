...
class Position:
    ...
    def __init__(self, symbol=None, leverage=None, short_quantity=None, short_avg_price=None, short_avg_open_price=None,
                 short_pnl_ratio=None, short_pnl_unreal=None, short_pnl=None, long_quantity=None, long_avg_price=None,
                 long_avg_open_price=None, long_pnl_ratio=None, long_pnl_unreal=None, long_pnl=None, long_pos_margin=None,
                 short_pos_margin=None, liquid_price=None,
        ...
        self.short_avg_open_price = short_avg_open_price  # 空仓开仓平均价格
        ...
        self.long_avg_open_price = long_avg_open_price  # 多长开仓平均价格
    ...
    def update(self, short_quantity=0, short_avg_price=0, short_avg_open_price=0, long_quantity=0, long_avg_price=0,
        ...
        self.short_avg_open_price = short_avg_open_price
        self.long_quantity = long_quantity
        self.long_avg_price = long_avg_price
        self.long_avg_open_price = long_avg_open_price
    ...
    def __str__(self):
        info = "[symbol: {symbol}, " \
            ...
            .format(symbol=self.symbol,
                    ...
                    long_quantity=self.long_quantity, long_avg_price=self.long_avg_price, long_avg_open_price=self.long_avg_open_price,
