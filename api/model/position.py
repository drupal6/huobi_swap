...
class Position:
    ...
    def __init__(self, symbol=None, leverage=None, short_quantity=None, short_avg_price=None, short_pnl_ratio=None,
                 short_pnl_unreal=None, short_pnl=None, long_quantity=None, long_avg_price=None,  long_pnl_ratio=None,
